...
musical_data = {
    "ISTJ": {
        ...
        "image": "https://images.unsplash.com/photo-1513151233558-d860c5398176?w=600", # 혁명/깃발 느낌
        "song": "🎶 추천 넘버: <One Day More>, <Who Am I?>"
    },
    "ISFJ": {
        "title": "레베카 (Rebecca) 🏰💙",
        "desc": "차분하고 헌신적인 ISFJ! 진심 어린 사랑으로 어두운 저택의 비밀을 극복해 나가는 '나(I)'의 따뜻하고도 강인한 모습에 깊이 공감하게 될 것입니다.",
        "image": "https://images.unsplash.com/photo-1508849789987-4e5333c12b78?w=600", # 고풍스러운 저택/성 느낌
    ...
    "INFJ": {
        ...
        "image": "https://images.unsplash.com/photo-1507676184212-d03ab07a01bf?w=600", # 재즈/오르페우스의 하프 느낌
    ...
    "INTJ": {
        ...
        "image": "https://images.unsplash.com/photo-1523821741446-edb2b68bb7a0?w=600", # 미스터리한 사과/어두운 톤
    ...
    "ISTP": {
        ...
        "image": "https://images.unsplash.com/photo-1532187863486-abf9d39d66e8?w=600", # 과학 실험실 느낌
    ...
    "ISFP": {
        ...
        "image": "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=600", # 밤하늘과 고양이
        "song": "🎶 추천 넘버: <Memory>"
    },
    "INFP": {
        ...
        "image": "https://images.unsplash.com/photo-1518199266791-5375a83190b7?w=600", # 붉은 장미와 오페라 가면 느낌
    ...
    "INTP": {
        ...
        "image": "https://images.unsplash.com/photo-1507668077129-56e32842fceb?w=600", # 어둡고 지적인 아카데미 서재
        "song": "🎶 추천 넘버: <단 하나의 미래>, <너의 꿈 속에서>"
    },
    "ESTP": {
        "title": "시카고 (Chicago) 🎷👠",
        "desc": "매 순간 자극과 즐거움을 쫓는 트렌디한 ESTP! 화려한 재즈 선율, 유쾌하고도 풍자적인 무대, 그리고 당당한 주인공들의 씬스틸러 매력에 200% 매료될 거예요!",
        "image": "https://images.unsplash.com/photo-1511192336575-5a79af67a629?w=600", # 재즈와 트럼펫/무대 느낌
    ...
    "ESFP": {
        ...
        "image": "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600", # 밝은 햇살과 그리스 바다 해변
    ...
    "ENFP": {
        ...
        "image": "https://images.unsplash.com/photo-1509248961158-e54f6934749c?w=600", # 신비로운 초록빛 마법 느낌
    ...
    "ENTP": {
        ...
        "image": "https://images.unsplash.com/photo-1520523839897-bd0b52f945a0?w=600", # 피아노 건반과 열정
    ...
    "ESTJ": {
        ...
        "image": "https://images.unsplash.com/photo-1474487548417-781cb71495f3?w=600", # 철도와 묵직한 시대적 배경
    ...
    "ESFJ": {
        ...
        "image": "https://images.unsplash.com/photo-1528605248644-14dd04022da1?w=600", # 신나는 파티와 화합의 에너지
    ...
    "ENFJ": {
        ...
        "image": "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=600", # 록 콘서트의 열기 가득한 조명
    ...
    "ENTJ": {
        ...
        "image": "https://images.unsplash.com/photo-1534447677768-be436bb09401?w=600", # 거친 파도와 복수의 여정
